...
const artNetPath = require$$1$4.app.isPackaged ? require$$1$1.join(process.resourcesPath, "artNetTc.js") : require$$1$1.join(__dirname, "..", "..", "public", "artNetTc.js");
...
require$$1$4.app.on("ready", () => {
  ...
  require$$1$4.ipcMain.on("contentHeight", (_e, height) => {
